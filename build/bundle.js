...
/***/ function(module, exports, __webpack_require__) {
	...
	var vue_api_1 = __webpack_require__(2);
	var vue_ext_1 = __webpack_require__(3);
	var ActionDetailComponent = (function (_super) {
	    __extends(ActionDetailComponent, _super);
	    function ActionDetailComponent() {
	        _super.apply(this, arguments);
	    }
	    __decorate([
	        vue_ext_1.prop
	    ], ActionDetailComponent.prototype, "action", void 0);
	    ActionDetailComponent = __decorate([
	        vue_ext_1.VueComponent('action-details-component', __webpack_require__(8))
	...
	function VueComponent(name, template, vueConfig) {
	    ...
	    return function (target) {
	        ...
	        (function (targetClass) {
	            var injectionPromise = injector_1.Injector.getInjectedDependencies(targetClass).then(function (dependencies) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class='panel panel-default'>\n  <div class='panel-heading'>\n    <h3 class='panel-title'>{{action.name}} -- Details</h3>\n  </div>\n  <div class='panel-body'>\n    <table class='table table-bordered table-condensed table-hover table-striped'>\n      <thead>\n        <tr>\n          <td>Consideration</td>\n          <td>Input</td>\n          <td>Output</td>\n        </tr>\n      </thead>\n      <tbody>\n        <template v-for='consideration in action.considerations'>\n          <tr>\n            <td>{{consideration.name}}</td>\n            <td>{{consideration.input}}</td>\n            <td>{{consideration.output}}</td>\n          </tr>\n        </template>\n      </tbody>\n    </table>\n  </div>\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vue_ext_1 = __webpack_require__(3);
	var vue_api_1 = __webpack_require__(2);
	var DecisionDetailComponent = (function (_super) {
	    __extends(DecisionDetailComponent, _super);
	    function DecisionDetailComponent() {
	        _super.call(this);
	    }
	    DecisionDetailComponent.prototype.selectAction = function (action) {
	        this.$parent.currentActionEntry = action;
	    };
	    __decorate([
	        vue_ext_1.prop
	    ], DecisionDetailComponent.prototype, "decision", void 0);
	    DecisionDetailComponent = __decorate([
	        vue_ext_1.VueComponent('decision-details-component', __webpack_require__(11))
	    ], DecisionDetailComponent);
	    return DecisionDetailComponent;
	}(vue_api_1.VueApi));
	exports.DecisionDetailComponent = DecisionDetailComponent;
...
/***/ function(module, exports) {
	...
	module.exports = "<div class='panel panel-default'>\n  <div class='panel-heading'>\n    <h3 class='panel-title'>{{decision.actionName}} -- Action List</h3>\n  </div>\n  <div class='panel-body'>\n    <table class='table table-bordered table-condensed table-hover table-striped'>\n      <thead>\n        <tr>\n          <td>Action</td>\n          <td>Score</td>\n        </tr>\n      </thead>\n      <tbody>\n        <template v-for='action in decision.actions'>\n          <tr v-on:click='selectAction(action)'>\n            <td>{{action.name}}</td>\n            <td>{{action.score}}</td>\n          </tr>\n        </template>\n      </tbody>\n    </table>\n  </div>\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vue_api_1 = __webpack_require__(2);
	var vue_ext_1 = __webpack_require__(3);
	var DecisionListComponent = (function (_super) {
	    __extends(DecisionListComponent, _super);
	    function DecisionListComponent() {
	        _super.call(this);
	    }
	    DecisionListComponent.prototype.select = function (entry) {
	        this.$parent.currentDecisionEntry = entry;
	    };
	    __decorate([
	        vue_ext_1.prop
	    ], DecisionListComponent.prototype, "decisionLog", void 0);
	    DecisionListComponent = __decorate([
	        vue_ext_1.VueComponent('decision-list-component', __webpack_require__(13))
	    ], DecisionListComponent);
	    return DecisionListComponent;
	}(vue_api_1.VueApi));
	exports.DecisionListComponent = DecisionListComponent;
...
/***/ function(module, exports) {
	...
	module.exports = "<div class='panel panel-default'>\n  <div class='panel-heading'>\n    <h3 class='panel-title'>{{decisionLog.entityName}} -- Decision Log</h3>\n  </div>\n  <div class='panel-body'>\n    <table class='table table-bordered table-condensed table-hover table-striped'>\n      <thead>\n        <tr>\n          <td>Decision Result</td>\n          <td>Score</td>\n          <td>Time</td>\n        </tr>\n      </thead>\n      <tbody>\n        <template v-for='decision in decisionLog.entries'>\n          <tr v-on:click='select(decision)'>\n            <td>{{decision.actionName}}</td>\n            <td>{{decision.score}}</td>\n            <td>?</td>\n          </tr>\n        </template>\n      </tbody>\n    </table>\n  </div>\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var serialize_1 = __webpack_require__(15);
	var consideration_log_entry_1 = __webpack_require__(16);
	var requirement_log_entry_1 = __webpack_require__(18);
	var ActionLogEntry = (function () {
	    function ActionLogEntry() {
	    }
	    ActionLogEntry.OnDeserialized = function (actionLogEntry, json) {
	        actionLogEntry.score = parseFloat((actionLogEntry.score).toFixed(4));
	    };
	    __decorate([
	        serialize_1.autoserialize
	    ], ActionLogEntry.prototype, "name", void 0);
	    __decorate([
	        serialize_1.autoserialize
	    ], ActionLogEntry.prototype, "context", void 0);
	    __decorate([
	        serialize_1.autoserialize
	    ], ActionLogEntry.prototype, "score", void 0);
	    __decorate([
	        serialize_1.autoserialize
	    ], ActionLogEntry.prototype, "weight", void 0);
	    __decorate([
	        serialize_1.autoserialize
	    ], ActionLogEntry.prototype, "time", void 0);
	    __decorate([
	        serialize_1.autoserializeAs(consideration_log_entry_1.Consideration)
	    ], ActionLogEntry.prototype, "considerations", void 0);
	    __decorate([
	        serialize_1.autoserializeAs(requirement_log_entry_1.Requirement)
	    ], ActionLogEntry.prototype, "requirements", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var serialize_1 = __webpack_require__(15);
	var response_curve_1 = __webpack_require__(17);
	var Consideration = (function () {
	    function Consideration() {
	    }
	    Consideration.OnDeserialized = function (consideration, json) {
	        consideration.curve = new response_curve_1.ResponseCurve(json.curve);
	    ...
	    __decorate([
	        serialize_1.autoserialize
	    ], Consideration.prototype, "name", void 0);
	    __decorate([
	        serialize_1.autoserialize
	    ], Consideration.prototype, "input", void 0);
	    __decorate([
	        serialize_1.autoserialize
	    ], Consideration.prototype, "output", void 0);
...
/***/ function(module, exports) {
	...
	"use strict";
	var ResponseCurve = (function () {
	    function ResponseCurve(compressedCurve) {
	...
	exports.ResponseCurve = ResponseCurve;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Requirement = (function () {
	    ...
	    __decorate([
	        serialize_1.autoserialize
	    ], Requirement.prototype, "passed", void 0);
	    return Requirement;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var serialize_1 = __webpack_require__(15);
	var action_log_entry_1 = __webpack_require__(14);
	var DecisionLogEntry = (function () {
	    function DecisionLogEntry() {
	    }
	    DecisionLogEntry.OnDeserialized = function (logEntry, json) {
	        logEntry.score = parseFloat(logEntry.score.toFixed(4));
	    };
	    __decorate([
	        serialize_1.autoserialize
	    ], DecisionLogEntry.prototype, "actionName", void 0);
	    __decorate([
	        serialize_1.autoserialize
	    ], DecisionLogEntry.prototype, "score", void 0);
	    __decorate([
	        serialize_1.autoserializeAs(action_log_entry_1.ActionLogEntry)
	    ], DecisionLogEntry.prototype, "actions", void 0);
	    return DecisionLogEntry;
	}());
	exports.DecisionLogEntry = DecisionLogEntry;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var serialize_1 = __webpack_require__(15);
	var decision_log_entry_1 = __webpack_require__(19);
	var DecisionLog = (function () {
	    function DecisionLog() {
	    }
	    __decorate([
	        serialize_1.autoserialize
	    ], DecisionLog.prototype, "entityName", void 0);
	    __decorate([
	        serialize_1.autoserializeAs(decision_log_entry_1.DecisionLogEntry)
	    ], DecisionLog.prototype, "entries", void 0);
	    return DecisionLog;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var injector_1 = __webpack_require__(6);
	var serialize_1 = __webpack_require__(15);
	var decision_log_1 = __webpack_require__(20);
	var json = __webpack_require__(22);
	injector_1.Injector.provideAsync('decisionLog', function () {
	    var log = serialize_1.Deserialize(json, decision_log_1.DecisionLog);
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"entries": [
			{
				"actionName": "Advance to Melee Range",
				"score": 0.8668311238288879,
				"actions": [
					{
						"name": "Advance to Melee Range",
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.22189415991306305,
								"output": 0.7780617475509644,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
								"input": 1,
								"output": 0.9232664108276367,
								"curve": "[Polynomial, -1,-4,1,-0.9,0]"
							},
							{
								"name": "When target has low health",
								"input": 0,
								"output": 1,
								"curve": "[Polynomial, -1,2,1,0,0]"
							}
						],
						"requirements": []
					},
					{
						...
						"considerations": [
							{
								"name": "When close to another entity",
								"input": -21.220539093017578,
								"output": 0,
								"curve": "[Polynomial, 1,1,0,0,0]"
							}
						],
						"requirements": []
					}
				...
				"actions": [
					{
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.20702776312828064,
								"output": 0.751373291015625,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
				...
				"actions": [
					{
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.17989493906497955,
								"output": 0.6957595348358154,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
				...
				"actions": [
					{
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.15468037128448486,
								"output": 0.6351404190063477,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
				...
				"actions": [
					{
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.12887242436408997,
								"output": 0.5629907250404358,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
				...
				"actions": [
					{
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.10766014456748962,
								"output": 0.4951275587081909,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
				...
				"actions": [
					{
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.08830955624580383,
								"output": 0.4257718324661255,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
				...
				"actions": [
					{
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.07089975476264954,
								"output": 0.356756329536438,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
				...
				"actions": [
					{
						...
						"considerations": [
							{
								"name": "When I am far from my target",
								"input": 0.05534576624631882,
								"output": 0.2893803119659424,
								"curve": "[Polynomial, -1,6,1,1,0]"
							},
							{
								"name": "When I am healthy",
...
/***/ function(module, exports) {
	...
	"use strict";
	function polynomial(input, slope, exp, vShift, hShift) {
	    return slope * ((input - hShift) ^ exp) + vShift;
	}
	exports.polynomial = polynomial;
	function inversePolynomial(input, slope, exp, vShift, hShift) {
	    var output = polynomial(input, slope, exp, vShift, hShift);
	    return polynomial(output, slope, exp, vShift, hShift);
	}
	exports.inversePolynomial = inversePolynomial;
	function buildPolynomial(slope, exp, vShift, hShift) {
	    return slope + " * ((x - " + hShift + ") ^ " + exp + ") + " + vShift;
	}
	exports.buildPolynomial = buildPolynomial;
	function buildInversePolynomial(slope, exp, vShift, hShift) {
	    return slope + " * ((y - " + hShift + ") ^ " + exp + ") + " + vShift;
	}
	exports.buildInversePolynomial = buildInversePolynomial;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var injector_1 = __webpack_require__(6);
	var SelectedEntryService = (function () {
	    function SelectedEntryService() {
	        this.selectedLogEntry = null;
	    }
	    return SelectedEntryService;
	}());
	exports.SelectedEntryService = SelectedEntryService;
	injector_1.Injector.provide('selection', new SelectedEntryService());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vue_ext_1 = __webpack_require__(3);
	var vue_api_1 = __webpack_require__(2);
	var decision_list_component_1 = __webpack_require__(12);
	var decision_details_1 = __webpack_require__(10);
	var action_details_1 = __webpack_require__(1);
	var injector_1 = __webpack_require__(6);
	...
	var MainVue = (function (_super) {
	    ...
	    __decorate([
	        vue_ext_1.data
	    ], MainVue.prototype, "currentDecisionEntry", void 0);
	    __decorate([
	        vue_ext_1.data
	    ], MainVue.prototype, "currentActionEntry", void 0);
	    __decorate([
	        injector_1.inject('decisionLog')
	    ], MainVue.prototype, "decisionLog", void 0);
	    MainVue = __decorate([
	        vue_ext_1.VueComponent("main-component", __webpack_require__(27))
	    ], MainVue);
	    return MainVue;
	}(vue_api_1.VueApi));
	...
	router.map({
	    ...
	    '/decisions': {
	        component: decision_list_component_1.DecisionListComponent.getVueClassAsync()
	    },
	    '/decisions/:decisionIndex': {
	        component: decision_details_1.DecisionDetailComponent.getVueClassAsync()
	    },
	    '/decisions/:decisionIndex/actions/:actionIndex': {
	        component: action_details_1.ActionDetailComponent.getVueClassAsync()
	    },
	});
	router.redirect({
	    '*': '/'
...
/***/ function(module, exports) {
	...
	module.exports = "<div class='row'>\n  <ol class='breadcrumb'>\n  </ol>\n  <div class='col-md-3'>\n    <decision-list-component v-bind:decision-log='decisionLog'></decision-list-component>\n  </div>\n  <div class='col-md-3'>\n    <decision-details-component v-if='currentDecisionEntry' v-bind:decision='currentDecisionEntry'></decision-details-component>\n    <action-details-component v-if='currentActionEntry' v-bind:action='currentActionEntry'></action-details-component>\n  </div>\n</div>";
